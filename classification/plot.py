...
def plotgraphs(e,acu,val_acu,loss,val_loss,m,accuracy_score):
    file = open("/home/abhishek/django_project4/classification/templates/temp_graphs.html","r+")
    ...
    with open('/home/abhishek/django_project4/classification/templates/temp_graphs.html', 'a') as f:
