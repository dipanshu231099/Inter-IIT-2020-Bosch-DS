...
- `BOSCH_sign` is the folder having all the `code+training data+models`.
- `Environment`  is the folder having all the depedencies installed into a virtual environment.
